...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // Visit https://my.pspdfkit.com to get your demo or commercial license key.
        SDK.setLicenseKey("YOUR_LICENSE_KEY_GOES_HERE")

        let window = UIWindow()
        do {
            // The serverURL needs to be an absolute URL that the PSPDFKit Document Engine can be reached at.
            ...
            documentsController.title = "PSPDFKit Instant"
